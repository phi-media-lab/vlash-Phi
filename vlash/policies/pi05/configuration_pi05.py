...
class PI05Config(PreTrainedConfig):
    ...
    suffix_backend: str = "local"  # Suffix rollout backend: "local", "dummy_local", "serialized_local", "numpy_local", "dispatched_numpy_local", or "queued_dispatched_numpy_local"
